...
\- \*\*ml\_service.py\*\* - ML сервис с обучением модели

\- \*\*monitoring\_service.py\*\* - Мониторинг дрейфа (EvidentlyAI)
